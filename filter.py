...
def filterIIR(data, nrk):
    ...
    if (flt_type == 1):  # 1-50Hz
        ...
        a = np.array(
            1, -2.355934631131582,
            1.941257088655214, -0.7847063755334187, 0.1999076052968340)
        ...
        a = np.array(
            1, -3.678895469764040,
            5.179700413522124, -3.305801890016702, 0.8079495914209149)
        ...
        b2 = np.array(0.9650809863447347, -0.2424683201757643,
            1.945391494128786, -0.2424683201757643, 0.9650809863447347)
        a2 = np.array(1, -0.2467782611297853,
    ...
    filtered = filtruj(b2, a2, b, a, nrk);
    return filtered;
